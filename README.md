<div align="center">
  ...
  <p>
    <a href="https://www.npmjs.com/package/dibosockets">
      <img src="https://img.shields.io/npm/v/dibosockets?color=blueviolet&label=version&logo=npm" alt="npm version" />
    </a>
    <a href="https://www.npmjs.com/package/dibosockets">    
      <img src="https://img.shields.io/npm/dt/dibosockets?color=blueviolet&label=downloads&logo=npm" alt="npm downloads" />
    </a>
    </p>
</div>
<p align="center">
  <a href="https://github.com/KINGXDEN/dibosockets"> 
    <img src="https://img.shields.io/badge/Lihat-Repositori%20GitHub-blue?style=for-the-badge&logo=github&logoColor=white" alt="Lihat Repositori GitHub">
  </a>
</p>
...
> `DiboSockets` is a refined version of the Baileys library with cleaner API usage, exclusive features like album messaging, newsletter controls, and full-size profile uploads — tailored for modern WhatsApp automation needs.
...
```json
"dependencies": {
  "@whiskeysockets/baileys": "npm:dibosockets@latest"
}
```
@adiwajsing/baileys
```json
"dependencies": {
  "@adiwajshing/baileys": "npm:dibosockets@latest"
}
```
baileys
```json
"dependencies": {
  "baileys": "npm:dibosockets@latest"
}
```

Or via terminal
```bash
npm install npm:dibosockets@latest
```
...
ESM
```bash
import makeWASocket from 'dibosockets'
```

CJS
```bash
const { default: makeWASocket } = require('dibosockets')
```
...
```javascript
// Create a newsletter
await sock.newsletterCreate("DiboSockets");

// Change description
await sock.newsletterUpdateDescription("dibosockets@newsletter", "Fresh updates weekly");

// Send a reaction to a channel message
await sock.newsletterReactMessage("dibosockets@newsletter", "175", "🔥");
```
...
const msg = {
  text: "Choose one:",
  footer: "From DiboSockets with love 💜",   
  buttons,
  headerType: 1
};
...
<p align="center">
  <a href="https://wa.me/6282144323683?text=hai, min?" target="_blank">
...
- **[RexxHayanasi](https://github.com/RexxHayanasi)**  
  For the original modified version of Baileys.

- **[Muh. Deni Setiawan](https://github.com/KINGXDEN)** (Me)  
  The main developer of this project.

</details>

> [!CAUTION]
> Built on top of the WhiskeySockets/Baileys project. All original core logic credits go to their team. Dibo Socket extends it with thoughtful UX and DX improvements.
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/KINGXDEN">
        <img src="https://avatars.githubusercontent.com/u/96621497?v=4" width="80px;" style="border-radius:50%;" alt="Muh. Deni Setiawan"/>
        <br />
        <sub><b>Muh. Deni Setiawan</b></sub>  
      </a>
    </td>
    <td align="center">
...
<td align="center">
      <a href="https://github.com/nstar-y">
        <img src="https://avatars.githubusercontent.com/u/81209428?v=4" width="80px;" style="border-radius:50%;" alt="nstar-y"/>
        <br />
        <sub><b>nstar-y</b></sub>
      </a>
    </td>
